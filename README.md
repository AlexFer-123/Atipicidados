...
```
cd existing_repo
git remote add origin https://gitlab.com/grandlab/Atipicidades.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/grandlab/Atipicidades/-/settings/integrations)
